...
├── README.md           # Este arquivo — visão geral e como jogar
...
└── docs/               # Documentação do código por tecnologia
    ├── README.md       # Índice da documentação técnica
    ├── HTML.md         # Estrutura (o esqueleto da página)
    ├── CSS.md          # Estilo (cores, layout, responsividade)
    └── JAVASCRIPT.md   # Lógica (gerador, cronômetro, dicas, regras)
```
...
- **HTML**: Estrutura da interface com aria-labels para acessibilidade — detalhes em [docs/HTML.md](docs/HTML.md)
- **CSS**: Design responsivo com variáveis de cor customizáveis — detalhes em [docs/CSS.md](docs/CSS.md)
- **JavaScript**: Lógica do jogo, gerador de puzzles, persistência e cronômetro — detalhes em [docs/JAVASCRIPT.md](docs/JAVASCRIPT.md)
